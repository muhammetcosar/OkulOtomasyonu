<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="devam.aspx.cs" Inherits="Kadmyo.Request.devam" %>
                                                ...
                                                <div class=control-group>
                                                    ...
                                                    <br />
                                                      <asp:Label ID="lbders" runat="server" Text="Dersi Seçiniz :"></asp:Label>
                                                       <asp:DropDownList ID="DERS" runat="server" AutoPostBack="True" DataTextField="DERSADI">
                                                       </asp:DropDownList>
                                                    </div>
                                                    <div>
               ...
               AutoGenerateColumns="False"  DataKeyNames="USERID" 
                OnSelectedIndexChanged="dgrList_SelectedIndexChanged" >
                                                       <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="devamsızlık">

                                                                <ItemTemplate>
                                                                         <asp:CheckBox  runat="server"  ID="cbH1" Checked="true" />----
                                                                         <asp:CheckBox  runat="server"  ID="cbH2" Checked="true"  />
